...
/*
He actualizado la tabla para permitir 52 instrucciones RV64I y expansión de pseudoinstrucciones
*/
...
enum Xv6TccInstructionKind {
  XV6_TCC_INSN_R,
  XV6_TCC_INSN_I,
  XV6_TCC_INSN_SHIFTI64, //OPeración con desplazamiento de 64 bits (codificación xv6_tcc_encode_shift_i con shamt_bits = 6 para indicar que el inmediato es de 64 bits)
  XV6_TCC_INSN_SHIFTIW,
...
struct Xv6TccInstruction {
  ...
  uint funct7; /* funct7 o bits superiores del inmediato de shift */ //permiten distinguir operaciones que aún coinciden en el formato T
