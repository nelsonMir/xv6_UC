...
/*
Une los argumentos argv[1], argv[2], ... para reconstruir la línea de ensamblador introducida en la shell
*/
static int
...
/*
Devuelve un nombre legible para el tipo de líneaa obtenido por el parser
*/
static const char *
